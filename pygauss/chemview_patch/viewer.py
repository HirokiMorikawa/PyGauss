# -*- coding: utf-8 -*-
"""
Created on Fri Apr 17 14:25:52 2015

@author: cjs14
"""

# CJS added non-relative paths
import numpy as np
...
class MolecularViewer(RepresentationViewer):
    ...
    # CJS added option for defined colorlist
    ...
    # CJS added option for defined colorlist
    def ball_and_sticks(self, ball_radius=0.05, stick_radius=0.02, colorlist=[]):
